...
echo "Kutuphanenin adi:". $nesne ->libraryName; /* Private olduğu için hata fırlatir. */
echo "<br>";
echo "Kutuphanenin kuruluş yili : ". $nesne::YEAR; /* Private olduğu için hata fırlatir. */
echo "<br>";

echo $nesne->getInfo(); /* Private olduğu için hata fırlatir. */
